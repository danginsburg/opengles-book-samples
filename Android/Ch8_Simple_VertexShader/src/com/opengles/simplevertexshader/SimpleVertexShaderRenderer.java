...
public class SimpleVertexShaderRenderer implements GLSurfaceView.Renderer {
	...
	{					
		...
		GLES20.glViewport ( 0, 0, mWidth, mHeight );
   		...
   		GLES20.glVertexAttribPointer ( mPositionLoc, 3, GLES20.GL_FLOAT, false, 0, mCube.getVertices() );
   		...
   		// Draw the cube
   		GLES20.glDrawElements ( GLES20.GL_TRIANGLES, mCube.getNumIndices(), GLES20.GL_UNSIGNED_SHORT, mCube.getIndices());
    }
